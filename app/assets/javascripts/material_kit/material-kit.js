...
$(window).resize(function(){
    if($(window).width() < 768){
        mk.initRightMenu();
    } else if(!burger_menu && mk.misc.navbar_menu_visible){
        mk.toggleSidebarMenu();
    }
});
...
mk = {
    ...
    initRightMenu: function(){
         if(!navbar_initialized){
            ...
            $toggle.click(mk.toggleSidebarMenu);
    ...
    toggleSidebarMenu: function(){
        if(mk.misc.navbar_menu_visible == 1) {
            $('html').removeClass('nav-open');
            mk.misc.navbar_menu_visible = 0;
            $('.body-click').remove();
             setTimeout(function(){
    ...
    initCollapseArea: function(){
        $('[data-toggle="mk-collapse"]').each(function () {
            var thisdiv = $(this).attr("data-target");
            $(thisdiv).addClass("mk-collapse");
        });

        $('[data-toggle="mk-collapse"]').hover(function(){
            var thisdiv = $(this).attr("data-target");
